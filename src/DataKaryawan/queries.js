...
const getDataKaryawanById = `select ka.id,
"nama",
"email",
"password",
"notelp",
...
"jawaban",
"sisajatah",
"roleid" from karyawan ka left join role ro on roleid = ro.id where ka.id = $1`;
...
const searchDataKaryawan = `
    ...
    lokasikerja,
    gaji from karyawan ka 
    left join role ro on roleid = ro.id 
    where 
    nama ilike $1 
    or jabatan ilike $1 
    or status ilike $1
