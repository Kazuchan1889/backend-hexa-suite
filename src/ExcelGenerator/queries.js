...
const excelKehadiran = require("../Kehadiran/queries");
...
const printDataLaporanPerOrang = excelLaporan.excelLaporanPerOrang;
const printDataAbsensiPerOrang = excelAbsensi.excelAbsensiPerOrang;

const printDataSummaryKehadiran = excelKehadiran.exportKehadiran;
...
module.exports = {
  ...
  printDataPayroll,
  printDataResign,
  printDataLaporanPerOrang,
  printDataAbsensiPerOrang,

  printDataSummaryKehadiran,
